...
var file_sf_stellar_type_v1_block_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x31, 0x3b, 0x70, 0x62, 0x73, 0x74, 0x65, 0x6c, 0x6c, 0x61, 0x72, 0x62, 0x06, 0x70,
...
var file_sf_stellar_type_v1_block_proto_goTypes = []any{
	...
	(*Transaction)(nil),           // 2: sf.stellar.type.v1.Transaction
...
var file_sf_stellar_type_v1_block_proto_depIdxs = []int32{
	...
	2, // 1: sf.stellar.type.v1.Block.transactions:type_name -> sf.stellar.type.v1.Transaction
	3, // 2: sf.stellar.type.v1.Block.created_at:type_name -> google.protobuf.Timestamp
	3, // 3: sf.stellar.type.v1.Transaction.created_at:type_name -> google.protobuf.Timestamp
