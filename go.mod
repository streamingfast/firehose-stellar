...
require (
	...
	github.com/stellar/go-stellar-sdk v0.7.2 // Protocol 27 (Zipper) release; adds CAP-0071 Soroban auth XDR (SOROBAN_CREDENTIALS_ADDRESS_V2 / _WITH_DELEGATES, ENVELOPE_TYPE_SOROBAN_AUTHORIZATION_WITH_ADDRESS) the pre-P27 SDK cannot decode.
...
require (
	...
	github.com/streamingfast/substreams v1.21.0 // indirect
